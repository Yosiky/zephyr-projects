...
K_THREAD_DEFINE(threadA, THREAD_STACK_SIZE,
    thread_a, NULL, NULL, NULL, THREAD_A_PRIO, 0, 0);

K_THREAD_DEFINE(threadB, THREAD_STACK_SIZE,
    thread_b, NULL, NULL, NULL, THREAD_B_PRIO, 0, 0);
